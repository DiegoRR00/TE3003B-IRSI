...
def audio_filter():
    ...
    wavfile.write("audios/Noisy Audio.wav", sampFreq, signal)
    wavfile.write("audios/Noisless Audio.wav", sampFreq, noiseless_signal)
    playsound("audios/Noisy Audio.wav")
    playsound("audios/Noisless Audio.wav")
